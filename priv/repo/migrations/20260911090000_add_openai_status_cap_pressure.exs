defmodule CodexPooler.Repo.Migrations.AddOpenAIStatusCapPressure do
  ...
  def change do
    ...
    create constraint(:openai_status_feed_states, :openai_status_feed_states_cap_pressure_check, check: "cap_pressure IN ('none', 'active_over_cap', 'terminal_exhausted')")
  end
end
