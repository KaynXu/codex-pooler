defmodule CodexPooler.ReleaseUpgradeMigrationsTest do
  ...
  for scenario <-
        ~w(widths fresh head invalid invalid_owner client_exit locks historical_indexes validation null_history migration_lock index_conflicts rollback_cancel rollback_delete) do
